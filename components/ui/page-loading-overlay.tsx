...
function MallHomeSkeleton() {
  return <MallFrameSkeleton><section className="rounded-2xl border border-white/80 bg-white/90 p-3 shadow-sm sm:p-4"><div className="flex items-center justify-between gap-2"><div className="flex min-w-0 items-center gap-2"><SkeletonBlock className="size-8 shrink-0 rounded-lg" /><SkeletonBlock className="h-4 w-28" /></div><SkeletonBlock className="h-8 w-20 rounded-lg" /></div><div className="mt-2 flex items-center justify-between gap-2"><SkeletonBlock className="h-4 w-16" /><SkeletonBlock className="h-7 w-20 rounded-lg" /></div><SkeletonBlock className="mt-2 h-9 w-full rounded-xl" /><SkeletonBlock className="mt-2 h-9 w-full rounded-xl" /></section><section className="mt-3 sm:mt-5"><div className="mb-2.5 flex justify-between sm:mb-3"><SkeletonBlock className="h-4 w-20" /><SkeletonBlock className="h-3 w-14" /></div><div className="grid grid-cols-2 gap-2.5 sm:grid-cols-[repeat(auto-fill,minmax(220px,280px))] sm:justify-start sm:gap-3">{Array.from({ length: 8 }, (_, index) => <article key={index} className="min-w-0 overflow-hidden rounded-xl border border-slate-200/85 bg-white sm:max-w-[280px] sm:rounded-2xl"><SkeletonBlock className="aspect-[4/3] w-full rounded-none sm:aspect-[1.16]" /><div className="space-y-2 p-2.5 sm:p-3"><SkeletonBlock className="h-3.5 w-3/4" /><SkeletonBlock className="h-3.5 w-1/2 sm:hidden" /><div className="hidden space-y-2 sm:block"><SkeletonBlock className="h-3 w-full" /><SkeletonBlock className="h-3 w-4/5" /></div><div className="flex justify-between pt-1 sm:pt-2"><SkeletonBlock className="h-4 w-10" /><SkeletonBlock className="h-5 w-12 rounded-full" /></div></div></article>)}</div></section></MallFrameSkeleton>
}
