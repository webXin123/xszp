  ...
  return (
    <div className={cn("relative flex flex-col gap-3 pb-6 lg:gap-3", styles.parentHome)}>
      ...
      <section className={cn("flex min-h-[340px] flex-col rounded-[18px] border border-[#dce3f8] bg-white p-3.5 shadow-[0_18px_40px_-32px_rgba(64,80,166,.65)] sm:p-4", mobileTab !== "home" && "lg:flex")}>
        ...
        {(mobileTab === "home" || mobileTab === "honors" || mobileTab === "activities") && <div role="tablist" aria-label="学生首页内容" className="grid w-full grid-cols-3 gap-1 rounded-2xl border border-[#d5ddf8] bg-white p-1 shadow-[0_8px_18px_-14px_rgba(64,80,166,.75)] lg:hidden">
        ...
        <section id="mobile-home-panel-semester-scores" role="tabpanel" aria-label="学期成绩" className={cn("pt-4 lg:hidden", mobileHomeContentTab !== "semester-scores" && "hidden")}>
          <MobileSemesterScores studentName={currentChild.name} academicHistory={academicHistory} fitnessHistory={fitnessHistory} />
        </section>

        <section id="mobile-home-panel-semester-report" role="tabpanel" aria-label="学期报告" className={cn("pt-4 lg:hidden", mobileHomeContentTab !== "semester-report" && "hidden")}>
